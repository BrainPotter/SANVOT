...
parser.add_argument('--dataset', default='VOT2018', type=str,
        help='datasets')
parser.add_argument('--config', default='/home/unitree/siamban/experiments/siamban_r50_l234/config.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default='/home/unitree/siamban/experiments/siamban_r50_l234/model.pth', type=str,
